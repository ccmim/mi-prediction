...
if __name__ == "__main__":
    ...
    parser.add_argument('--lat_dim', default=1024, type=int)
    ...
    parser.add_argument('--dir_ids', type=str, default='./input_data/ids/ids_MI_4_test_mtdt.csv') # non_stroke_MI_ids_mtdt # ids_MI_4_test_mtdt
    parser.add_argument('--sax_img_size', type=list, default=[512, 512, 15])
    parser.add_argument('--fundus_img_size', type=int, default=512)
    ...
    parser.add_argument('--dir_weights_mcvae', type=str, default='./results/2021-03-13_03-12-01_fundus_size_512_ids_manual_LVM_LVEDV_mtdt_reduced/')
    parser.add_argument('--dir_weights_regressor', type=str, default='results_regressor/2021-04-02_14-08-47_best/')
