...
from dataloader.MM_loader_4_test_age_gender import MM_loader
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dir_weights_mcvae', type=str, default='./results/2021-04-04_01-26-31_fundus_size_128_ids_1415_subjects_automatic_LVM_LVEDV_mtdt_reduced/')
    parser.add_argument('--dir_weights_regressor', type=str, default='results_regressor/2021-04-05_01-21-08_age_gender/')
    ...
    pred_file_name =  args.dir_results + 'age_gender_1415_subjects_' + args.dir_ids.split('/')[-1][:-4]  + '_preds.csv'
