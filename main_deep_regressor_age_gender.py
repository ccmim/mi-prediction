...
from dataloader.MM_loader_reg_age_gender import MM_loader
    ...
    for epoch in range(0, args.epochs):
        ...
        if (epoch % 5) == 0:
            ...
            if best_metric > validation_loss:
                ...
                best_iter = epoch
            model_save_file = os.path.join(args.save_dir, args.save_model + str(epoch) + '_.tar')
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dir_mcvae_res', type=str, default='./results/2021-04-04_01-26-31_fundus_size_128_ids_1415_subjects_automatic_LVM_LVEDV_mtdt_reduced/')
    ...
    parser.add_argument('--num_mtdt', type=int, default=2)
    ...
    parser.add_argument('--results_dir', type=str, default='2021-04-05_01-21-08_age_gender/') # Only change it when testing
    ...
    if args.train:
        ...
        train_loader = MM_loader(batch_size = args.batch_size,
                                   fundus_img_size = 16, # We can remove this bit
        ...
        args.save_dir = args.save_dir + datetime.datetime.now().strftime('%Y-%m-%d_%H-%M-%S') + '_age_gender' + '/'
