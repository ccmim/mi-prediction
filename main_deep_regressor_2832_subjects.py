...
if __name__ == "__main__":
    ...
    parser.add_argument('--dir_mcvae_res', type=str, default='./results/2021-03-29_23-30-26_fundus_size_128_ids_2832_subjects_automatic_LVM_LVEDV_mtdt_reduced/')
    ...
    parser.add_argument('--results_dir', type=str, default='2021-03-21_13-15-50/') # Only change it when testing
